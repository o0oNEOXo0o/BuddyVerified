 ...
 * Description: Allows admins to specify verified accounts and groups. Adds a badge to verified user and group avatars.
 * Version:     2.4.2
 * Author:      modemlooper
...
final class BuddyVerified {
	...
	public function plugin_classes() {
		...
		if ( bp_is_active( 'groups' ) ) {
			$this->groups = new BV_Groups( $this );
		}
